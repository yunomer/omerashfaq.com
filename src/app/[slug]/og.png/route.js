...
export async function GET(_, { params }) {
  const { slug } = params
  const [seoData = {}, regularFont, boldFont] = await Promise.all([getPageSeo(slug), getRegularFont(), getBoldFont()])
  ...
  return new ImageResponse(
    <OpenGraphImage title={ogImageTitle || title} subtitle={ogImageSubtitle || description} icon={icon} />,
    {
      ...size,
      fonts: [
        {
